...
# Tuk-Tuk Rush perspective renderer

Latest direction: restored the original overhead road with constant-size detailed vehicles. The five original storefronts now scroll gently without perspective zoom, and stop in reduced-motion mode. Khmer Market Match has an original CSS wooden table and woven mat; no downloaded assets or new licenses were required.
