...
const gameData = [
  ['angkor-runner', 'Angkor Runner', 'Jump logs, slide under branches and collect gold coins on an original fictional Khmer-inspired forest trail. Endless browser runner with guest play and local best scores.'],
